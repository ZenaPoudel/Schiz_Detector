...
# 			print(f"train loss: {loss.item():.4f}")
			...
			if batch_F1!=batch_F1:
				...
				batch_F1 =batch_F1.item()
# 			print(batch_F1)

			epoch_train_F1 += batch_F1

			print(f"{step}/{epoch_len}, train loss: {loss.item():.4f}, train_accuracy: {batch_acc:.4f}, train_precision: {batch_precision.item():.4f}, train_recall: {batch_recall.item():.4f}, train_F1: {batch_F1:.4f}")
